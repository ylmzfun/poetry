 ...
 * @LastEditTime: 2026-01-20 18:30:00
...
### 项目概述
古文辞章汇编是一个系统收集、整理和展示中国古代文学经典作品的开源项目，旨在为读者提供一个全面、系统的中国古代文学资源库。项目涵盖了从先秦到明清的大量文学作品，包括诗词、散文、赋辞、铭碑等多种文体，以及四书五经、诸子百家等国学经典。
...
### 项目特色
- **分类清晰**：按体裁、朝代、作者等多种方式分类，便于检索
- **内容丰富**：收录从先秦到明清的30万+篇经典文学作品
- **版本权威**：参考权威版本，确保内容准确性
- **便于对读**：按体裁相近、风格相似、主题相通的原则汇编，便于对比学习
- **开源共享**：采用MIT许可证开源，欢迎各界人士参与和贡献
...
| 📝 **文体类型** | 📖 **特点** |  **代表作品** |
|:---:|:---:|:---|
| **📜 表疏类** | 奏章疏文，情理并茂 | [陈情表](./表疏/陈情表.md) · [前出师表](./表疏/前出师表.md) · [后出师表](./表疏/后出师表.md) · [谏太宗十思疏](./表疏/谏太宗十思疏.md) |
| **📖 序记类** | 序文记事，文采飞扬 | [滕王阁序](./序记/滕王阁序.md) · [兰亭集序](./序记/兰亭集序.md) · [岳阳楼记](./序记/岳阳楼记.md) · [醉翁亭记](./序记/醉翁亭记.md) |
| **🎨 赋辞类** | 铺陈描写，辞藻华美 | [前赤壁赋](./赋辞/前赤壁赋.md) · [后赤壁赋](./赋辞/后赤壁赋.md) · [洛神赋](./赋辞/洛神赋.md) · [子虚赋](./赋辞/子虚赋.md) |
| **⚡ 铭碑类** | 简洁明快，寓意深远 | [陋室铭](./铭碑/陋室铭.md) · [潮州韩文公庙碑](./铭碑/潮州韩文公庙碑.md) |
| **🎵 诗词类** | 韵律优美，情感丰富 | 唐诗、宋词、元曲等各朝代诗词精选 |
...
### 链接约定
- **仓库浏览**：根 README 的文内链接统一为 `./...`
- **站点浏览**：站内链接使用分类路径，如 `诗词/唐诗/将进酒`

## 🤝 贡献指南

欢迎各界人士参与项目贡献！您可以通过以下方式参与：

1. **提交Issue**：报告问题、提出建议或功能需求
2. **提交Pull Request**：修复bug、添加新功能或改进文档
3. **内容贡献**：提供新的文学作品、注释或赏析内容
4. **反馈意见**：提供使用体验、功能改进等方面的反馈
...
- **邮箱**：ylmzfun@163.com
- **GitHub Issues**：https://github.com/ylmzfun/poetry/issues
- **项目主页**：https://github.com/ylmzfun/poetry

## 🙏 致谢

感谢所有为项目做出贡献的人，以及所有支持和使用本项目的用户！
